...
class RollTestCase(FriskyTestCase):
    def test_roll_defaults_to_d20(self):
        ...
        patcher.start()
        self.assertEqual('dummyuser rolled 1d20 and it\'s a 10 with a chance of 5%', self.send_message('?roll'))
        patcher.stop()
    ...
    def test_roll_considers_modifier(self):
        ...
        patcher.stop()
        self.assertEqual('dummyuser rolled 1d6+1 and it\'s a 1 with a chance of 16.66666667%', result)
    ...
    def test_multiple_inputs(self):
        patcher = mock.patch(target='plugins.roll.die_roll.randint', new=lambda *a, **k: 10)
        patcher.start()
        self.assertEqual('dummyuser rolled 1d20 and it\'s a 10 with a chance of 5%, 1d20 and it\'s a 10 with a chance of 5%, 1d20 and it\'s a 10 with a chance of 5%', self.send_message('?roll 1d20 1d20 1d20'))
        patcher.stop()
    ...
    def test_critical(self):
        ...
        patcher.stop()
        self.assertEqual('dummyuser rolled 2d20+1 and it\'s a 41 CRITICAL with a chance of 0.25%', result)
    ...
    def test_reasonable_estimation(self):
        ...
        patcher.stop()
        self.assertEqual('dummyuser rolled 10d6 and it\'s a 40 with a chance of 4.81117823%ish', result)
    ...
    def test_slowest_possible(self):
        ...
        patcher.stop()
        self.assertEqual('dummyuser rolled 4d50 and it\'s a 200 CRITICAL with a chance of 0.000016%', result)
    ...
    def test_weird_result(self):
        ...
        self.assertEqual('dummyuser rolled 100d100 and it\'s a 10000 CRITICAL with a chance of 0%ish', result)
